...
async function loadTelegramData() {
  ...
  try {
    return await readJsonFallback(telegramDataPath, { botToken: '', contacts: {}, messages: {} });
  } catch {
    const empty = { botToken: '', contacts: {}, messages: {} };
    await writeJsonFallback(telegramDataPath, empty);
    return empty;
  }
}
